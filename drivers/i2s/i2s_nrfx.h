...
{													\
	...
	{	                                                                                        \
		.frequency = 22050, 	                                                                \
		.ratio = {NRF_I2S_RATIO_96X, NRF_I2S_RATIO_96X, NRF_I2S_RATIO_96X},	                \
		.divider = {NRF_I2S_MCK_32MDIV15, NRF_I2S_MCK_32MDIV15, NRF_I2S_MCK_32MDIV15},	        \
	},	                                                                                        \
	{	                                                                                        \
		.frequency = 24000, 	                                                                \
		.ratio = {NRF_I2S_RATIO_32X, NRF_I2S_RATIO_32X, NRF_I2S_RATIO_96X},	                \
	...
	{	                                                                                        \
		.frequency = 44100, 	                                                                \
		.ratio = {NRF_I2S_RATIO_48X, NRF_I2S_RATIO_32X, NRF_I2S_RATIO_48X},	                \
		.divider = {NRF_I2S_MCK_32MDIV15, NRF_I2S_MCK_32MDIV23, NRF_I2S_MCK_32MDIV15},	        \
	},	                                                                                        \
	{	                                                                                        \
		.frequency = 48000, 	                                                                \
		.ratio = {NRF_I2S_RATIO_64X, NRF_I2S_RATIO_64X, NRF_I2S_RATIO_48X},	                \
		.divider = {NRF_I2S_MCK_32MDIV10, NRF_I2S_MCK_32MDIV10, NRF_I2S_MCK_32MDIV15},	        \
	},	                                                                                        \
}
