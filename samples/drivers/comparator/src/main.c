 ...
 *   NRF_COMP_REF_ARef
 */
#define COMP_REFERENCE_TYPE NRF_COMP_REF_ARef
 ...
 */
#define COMP_OPERATING_MODE NRF_COMP_MAIN_MODE_Diff
 ...
 *   NRF_COMP_INPUT_7
 */
#define COMP_INPUT NRF_COMP_INPUT_3
...
u8_t calc_th_reg_value(u8_t value_percent)
{
	...
	if (value_percent > 100) {
		printk("\nvalue is greater than 100%. Setting value to 100%");
	}
	else {
